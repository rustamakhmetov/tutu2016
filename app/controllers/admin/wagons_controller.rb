class Admin::WagonsController < Admin::BaseController
  ...
  def create
    ...
    if @wagon.save
      redirect_to [:admin, @train], notice: 'Вагон успешно добавлен.'
    else
      render :new
    end
  end
  ...
  def update
    if @wagon.update(wagon_params)
      redirect_to [:admin, @wagon], notice: 'Вагон успешно обновлен.'
    else
      render :edit
    end
  end
  ...
  def destroy
    @wagon.destroy
    redirect_to admin_wagons_url, notice: 'Вагон успешно удален.'
  end
